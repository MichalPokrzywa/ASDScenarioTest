...
namespace UnitEye
{
    public class EyeHelper
    {
        ...
        public void CalibrateDrowsyStats(bool calibrating)
        {
            ...
            if (Calibrating && (CalibrationCount < 301 /**|| calibrating*/) && CalibrationCount < _maxCalibrationCount)
            {
                //Calibrating until CalibrationCount > 300 and calibrating is false
                //Calibrationg can be ongoing after CalibrationCount > 300 if calibrating stays true
